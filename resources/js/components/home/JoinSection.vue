...
<template>
    <section
        class="wrap mt-0 flex flex-col border-b border-[#D3D8E1] bg-white text-navy md:mt-12 md:border-y lg:mt-14 2xl:mt-20 4xl:mt-26 dark:border-[#30456B] dark:bg-[#070F1C] dark:text-white"
    >
        <div class="flex w-full flex-col lg:flex-row lg:items-stretch">
            <!-- LEFT COLUMN -->
            <div
                class="join-content-left md:container-pr flex w-full flex-1 flex-col gap-4 bg-white py-16 md:flex-[0_0_44%] md:gap-5 lg:pr-16 xl:pr-20 dark:bg-[#070F1C]"
                data-reveal="up"
            >
                ...
                <p class="subtitle text-navy-light dark:text-white/80">
                    {{ t('home.join.subtitle') }}
                </p>

                <div class="flex flex-col gap-3 sm:gap-4 md:gap-4 lg:gap-5">
                    <p
                        class="body max-w-full lg:max-w-md xl:max-w-lg 2xl:max-w-xl dark:text-white/80"
                    >
                        {{ t('home.join.body1') }}
                    </p>
                    <p
                ...
                >
                    ...
                    >
                        ...
                        <span class="body dark:text-white/80">
                            {{ value }}
                        </span>
                    </li>
                </ul>
                ...
                <div class="mt-2 sm:mt-3 lg:mt-4">
                    <Link
                        :href="route('careers')"
                        class="flex w-full items-center justify-center rounded-[6px] bg-[#0B1F3F] px-6 py-3 transition-all duration-200 hover:-translate-y-px hover:bg-[#1a3358] hover:shadow-[0_6px_20px_rgba(11,31,58,0.28)] active:translate-y-0 active:bg-[#081629] sm:h-[44px] sm:px-7 md:h-[46px] md:px-8 lg:h-[50px] lg:w-fit lg:rounded-lg lg:px-8 2xl:h-[55px] 2xl:px-10 dark:bg-[#FFB200]/80 dark:hover:bg-[#E3C45F] dark:active:bg-[#B8933D]"
                    >
            ...
            <!-- RIGHT COLUMN -->
            <div
                class="relative min-h-[500px] w-full sm:min-h-[540px] md:min-h-[600px] lg:min-h-0 lg:flex-1 xl:min-h-[540px] 2xl:min-h-[560px]"
                data-reveal="fade"
            ...
            >
                ...
                >
                    <blockquote
                        class="title-section w-full max-w-xs text-center sm:max-w-sm md:max-w-md lg:max-w-sm xl:max-w-md 2xl:max-w-lg"
                        data-reveal="up"
                        data-reveal-delay="200"
                    >
                        <span class="text-white"
                            >“{{ t('home.join.right_quote_prefix') }}</span
                        ><span class="text-highlight-gold ms-3"
                            >{{ t('home.join.right_quote_highlight') }}”</span
                        >
                    </blockquote>
                </div>
            </div>
